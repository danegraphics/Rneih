...
There are many other possibilities for what properties should be considered or weighted when evaluating a keyboard layout. For example: Should a pinky-to-ring combination be discouraged? Is the top row preferable to the bottom row? On which fingers? Are adjascent finger combos better or worse than separated finger combos? Etc...
